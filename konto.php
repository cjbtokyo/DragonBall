...
if(isset($_GET['zmien_opis']) && !empty($_POST['opis'])){
	...
	mysql_query("update dragonball_gracze set opis = '".$_POST['opis2']."' where gracz = ".$uzytkownik['gracz']);
	...
	if(($_POST['haslo'] != $_POST['haslo2'])){
		...
		mysql_query("update dragonball_gracze set haslo = '".$_POST['nowe']."' where gracz = ".$uzytkownik['gracz']);
	...
	if(is_uploaded_file($plik_tmp)) {
		 ...
		 mysql_query("update dragonball_gracze set avatar = 1 where gracz = ".$uzytkownik['gracz']);
